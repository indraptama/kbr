<template lang="pug">
  div(class="")
    ...
    //- this is Highlight news 
    div(class="bg-white py-8 px-4")
      div(class="w-full max-w-4xl mx-auto")
        ul(class="list-reset flex topHighlight")
          li(v-for='top in tops' class="w-1/3")
            <TopHighlights :title='top.name' :imgUrl="top.imgUrl"/>
    ...
    div(class="px-4 border-t")
      div(class="flex w-full max-w-4xl mx-auto")
        ...
        // Center
        div(class="mx-auto max-w-lg w-1/2 pt-4 border-l border-r")
          ul(class="list-reset")
